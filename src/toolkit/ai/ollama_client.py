    ...
    def get_response(self, system_prompt: str, chat_history: list, model_name: str):
        ...
        if compatible_history:
            ...
            if first_user_message_index != -1:
                ...
                original_content = compatible_history[first_user_message_index][
                    "content"
                ]
                compatible_history[first_user_message_index]["content"] = (
        ...
        try:
            ...
            print(
                f"🔴 ERROR: Could not connect to Ollama server at {self.host}. "
                "Is it running?"
            )
